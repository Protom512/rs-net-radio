...
- [ ] 1. エラーハンドリング基盤の構築
- [x] 1.1 thiserrorとanyhowを使用したエラー型の定義 (P)
  ...
  - _Completed: 2025-01-16T06:00:00.000Z_
...
- [x] 1.3 unwrap()およびexpect()の排除とエラー伝播
...
- [x] 2.1 HTML解析とストリーミングURL抽出
  ...
  - _Requirements: 3.3_
  - _Completed: 2025-01-17T06:00:00.000Z_

- [x] 2.2 HTTPステータスコード403/429のエラーハンドリング (P)
...
- [x] 3.1 4KBチャンク処理の実装
  ...
  - _Requirements: 2.2_
  - _Completed: 2025-01-17T08:00:00.000Z_

- [x] 3.2 メモリ使用量の監視と制限 (P)
  - メモリ使用量のリアルタイム監視ロジックを実装
  - 512MB制限のチェックと警告メカニズム
  - 制限超過時の適切なエラーハンドリングとリソース解放
  - メモリリークの検出と防止
  - _Requirements: 2.2_
  - _Completed: 2025-01-17T07:00:00.000Z_
...
- [x] 4.1 録音結果の収集と集計 (P)
  ...
  - _Requirements: 1.4_
  - _Completed: 2025-01-17T09:00:00.000Z_
...
- [x] 5. 統合と検証
- [x] 5.1 エラーハンドリングの統合テスト
  - 致命的エラーと回復可能エラーの統合テストケース作成
  - エラーログの出力形式と内容の検証
  - 終了コードの正確性テスト
  - _Requirements: 4.2, 4.3, 4.4_
  - _Completed: 2025-01-17T10:00:00.000Z_

- [x] 5.2 Hibikiラジオ対応の統合テスト (P)
